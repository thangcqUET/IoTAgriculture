...
public abstract class HumanDetectionSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x0007;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_HUMAN_DETECTION_STATUS = (byte)0xB1;
	 ...
	 * <br>
	 * Contents of property :<br>
	 * This property indicates human detection status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Human detection status found = 0x41 Human detection status not found = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 * Data size : 1 byte<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getHumanDetectionStatus();
	/**
	 * Property name : Human detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	...
	public static class Proxy extends HumanDetectionSensor {
