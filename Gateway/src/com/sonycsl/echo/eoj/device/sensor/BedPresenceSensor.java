...
public abstract class BedPresenceSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x0028;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_BED_PRESENCE_DETECTION_STATUS = (byte)0xB1;
	...
	/**
	 * Property name : Bed presence detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates bed presence detection status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Bed presence detected = 0x41, Bed presence not detected = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 * Data size : 1 byte<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getBedPresenceDetectionStatus();
	/**
	 * Property name : Bed presence detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidBedPresenceDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_BED_PRESENCE_DETECTION_STATUS : return getBedPresenceDetectionStatus();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_BED_PRESENCE_DETECTION_STATUS : return isValidBedPresenceDetectionStatus(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL : 
				...
				return true;
			case EPC_BED_PRESENCE_DETECTION_STATUS : 
				onGetBedPresenceDetectionStatus(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetBedPresenceDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Getter reqGetBedPresenceDetectionStatus() {
			reqGetProperty(EPC_BED_PRESENCE_DETECTION_STATUS);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Informer reqInformBedPresenceDetectionStatus() {
			reqInformProperty(EPC_BED_PRESENCE_DETECTION_STATUS);
			return this;
		}
	}

	public static class Proxy extends BedPresenceSensor {
