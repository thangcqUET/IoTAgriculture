...
public abstract class CondensationSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x000A;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_CONDENSATION_DETECTION_STATUS = (byte)0xB1;
	...
	/**
	 * Property name : Condensation detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates condensation detection status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Condensation detection status found = 0x41<br>
	 * Condensation detection status not found = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 * Data size : 1 byte<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getCondensationDetectionStatus();
	/**
	 * Property name : Condensation detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidCondensationDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_CONDENSATION_DETECTION_STATUS : return getCondensationDetectionStatus();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_CONDENSATION_DETECTION_STATUS : return isValidCondensationDetectionStatus(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL : 
				...
				return true;
			case EPC_CONDENSATION_DETECTION_STATUS : 
				onGetCondensationDetectionStatus(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetCondensationDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Getter reqGetCondensationDetectionStatus() {
			reqGetProperty(EPC_CONDENSATION_DETECTION_STATUS);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Informer reqInformCondensationDetectionStatus() {
			reqInformProperty(EPC_CONDENSATION_DETECTION_STATUS);
			return this;
		}
	}

	public static class Proxy extends CondensationSensor {
		...
		@Override
		protected byte[] getCondensationDetectionStatus() {return null;}
	}
