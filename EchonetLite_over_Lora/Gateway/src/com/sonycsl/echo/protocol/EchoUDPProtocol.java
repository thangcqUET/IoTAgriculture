...
public class EchoUDPProtocol extends EchoProtocol {
	...
	public void openUDP() throws IOException {
		...
		mMulticastSocket.setNetworkInterface(EchoUtils.getMulticastNetworkInterface());
		mMulticastSocket.joinGroup(mMulticastAddress);
		mMulticastSocket.setLoopbackMode(true);
		mMulticastSocket.setSoTimeout(100000);
	}
	...
	private DatagramPacket rxPacket = new DatagramPacket(new byte[UDP_MAX_PACKET_SIZE], UDP_MAX_PACKET_SIZE);
