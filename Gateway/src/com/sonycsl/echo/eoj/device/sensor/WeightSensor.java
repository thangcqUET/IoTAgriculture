...
public abstract class WeightSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x0010;
	...
	/**
	 * Property name : Weight detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates weight detection status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Weight detection status found<br>
	 * = 0x41<br>
	 * Weight detection status not found = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 * Data size : 1 byte<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidWeightDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_WEIGHT_DETECTION_STATUS : return getWeightDetectionStatus();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_WEIGHT_DETECTION_STATUS : return isValidWeightDetectionStatus(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_WEIGHT_DETECTION_STATUS : 
				onGetWeightDetectionStatus(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetWeightDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetWeightDetectionStatus() {
			reqGetProperty(EPC_WEIGHT_DETECTION_STATUS);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		...
		public Informer reqInformWeightDetectionStatus() {
			reqInformProperty(EPC_WEIGHT_DETECTION_STATUS);
			return this;
		}
	}

	public static class Proxy extends WeightSensor {
		...
		@Override
		protected byte[] getWeightDetectionStatus() {return null;}
	}
