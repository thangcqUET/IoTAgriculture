...
public abstract class SnowSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x002C;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_SNOW_DETECTION_STATUS = (byte)0xB1;
...
byte<br>
	...
	/**
	 * Property name : Snow detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates snow detection<br>
	 * <br>
	 * Value range (decimal notation) :<br>
...
byte<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getSnowDetectionStatus();
	/**
	 * Property name : Snow detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
...
byte<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidSnowDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_SNOW_DETECTION_STATUS : return getSnowDetectionStatus();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_SNOW_DETECTION_STATUS : return isValidSnowDetectionStatus(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL : 
				...
				return true;
			case EPC_SNOW_DETECTION_STATUS : 
				onGetSnowDetectionStatus(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
...
byte<br>
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetSnowDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
...
byte<br>
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Getter reqGetSnowDetectionStatus() {
			reqGetProperty(EPC_SNOW_DETECTION_STATUS);
			return this;
		}
	}
...
byte<br>
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Informer reqInformSnowDetectionStatus() {
			reqInformProperty(EPC_SNOW_DETECTION_STATUS);
			return this;
		}
	}

	public static class Proxy extends SnowSensor {
		...
		@Override
		protected byte[] getSnowDetectionStatus() {return null;}
	}
