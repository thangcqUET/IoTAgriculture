...
public abstract class WaterLeakSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x0017;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_WATER_LEAK_DETECTION_STATUS = (byte)0xB1;
	...
	/**
	 * Property name : Water leak detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates water leak detection status<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getWaterLeakDetectionStatus();
	/**
	 * Property name : Water leak detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidWaterLeakDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_WATER_LEAK_DETECTION_STATUS : return getWaterLeakDetectionStatus();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_WATER_LEAK_DETECTION_STATUS : return isValidWaterLeakDetectionStatus(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL : 
				...
				return true;
			case EPC_WATER_LEAK_DETECTION_STATUS : 
				onGetWaterLeakDetectionStatus(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetWaterLeakDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Getter reqGetWaterLeakDetectionStatus() {
			reqGetProperty(EPC_WATER_LEAK_DETECTION_STATUS);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Informer reqInformWaterLeakDetectionStatus() {
			reqInformProperty(EPC_WATER_LEAK_DETECTION_STATUS);
			return this;
		}
	}

	public static class Proxy extends WaterLeakSensor {
		...
		@Override
		protected byte[] getWaterLeakDetectionStatus() {return null;}
	}
