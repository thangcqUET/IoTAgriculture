...
public abstract class CallSensor extends DeviceObject {
	...
	public static final short ECHO_CLASS_CODE = (short)0x0009;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_CALL_STATUS = (byte)0xB1;
	public static final byte EPC_CALL_HOLDING_TIME = (byte)0xBE;
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidCallStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	/**
	 * Property name : Call holding time<br>
	 * <br>
	 * EPC : 0xBE<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates the call holding time in units of 10 seconds.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * 0x0000.0xFFFD<br>
	 ...
	 * Get - optional<br>
	 */
	protected boolean isValidCallHoldingTime(byte[] edt) {
	...
	protected synchronized boolean setProperty(EchoProperty property) {
		...
		case EPC_CALL_HOLDING_TIME : return setCallHoldingTime(property.edt);
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_CALL_STATUS : return getCallStatus();
		case EPC_CALL_HOLDING_TIME : return getCallHoldingTime();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_CALL_STATUS : return isValidCallStatus(property.edt);
		case EPC_CALL_HOLDING_TIME : return isValidCallHoldingTime(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onSetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_CALL_HOLDING_TIME : 
				onSetCallHoldingTime(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_CALL_STATUS : 
				onGetCallStatus(eoj, tid, esv, property, success);
				return true;
			case EPC_CALL_HOLDING_TIME : 
				onGetCallHoldingTime(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetCallStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
		/**
		 * Property name : Call holding time<br>
		 * <br>
		 * EPC : 0xBE<br>
		 ...
		 * Get - optional<br>
		 */
		protected void onSetCallHoldingTime(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
		/**
		 * Property name : Call holding time<br>
		 * <br>
		 * EPC : 0xBE<br>
		 ...
		 * Get - optional<br>
		 */
		protected void onGetCallHoldingTime(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Proxy extends CallSensor {
		...
		@Override
		protected byte[] getCallStatus() {return null;}
	}
