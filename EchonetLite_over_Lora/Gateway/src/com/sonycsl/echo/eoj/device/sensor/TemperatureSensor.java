...
public abstract class TemperatureSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x0011;
	 ...
	 * Get - mandatory<br>
	 */
	protected boolean isValidMeasuredTemperatureValue(byte[] edt) {
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		switch(epc) {
		case EPC_MEASURED_TEMPERATURE_VALUE : return getMeasuredTemperatureValue();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		switch(property.epc) {
		case EPC_MEASURED_TEMPERATURE_VALUE : return isValidMeasuredTemperatureValue(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_MEASURED_TEMPERATURE_VALUE : 
				onGetMeasuredTemperatureValue(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
	...
	public static class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetMeasuredTemperatureValue() {
			reqGetProperty(EPC_MEASURED_TEMPERATURE_VALUE);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		...
		public Informer reqInformMeasuredTemperatureValue() {
			reqInformProperty(EPC_MEASURED_TEMPERATURE_VALUE);
			return this;
		}
	}

	public static class Proxy extends TemperatureSensor {
		...
		@Override
		protected byte[] getMeasuredTemperatureValue() {return null;}
	}
