...
//            timeToUpdateOperationStatus = Integer.parseInt(args[3]);
            ...
            mode = 0;
            timeToWaitUpdateDevices = 60000;
            timeToReUpdateDevices = 30000;
            timeToUpdateData = 20000;
...
//                if(topic.equals("/iot_agriculture/controlling/reset_12345678/")){
//                    try {
...
//                }
            ...
            ControlReceiver controlReceiver = ControlReceiver.getInstance();
            controlReceiver.sendToDevice(mqttMessage);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
