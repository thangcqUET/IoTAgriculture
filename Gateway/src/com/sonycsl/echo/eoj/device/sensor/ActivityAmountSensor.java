...
bytes<br>
	...
	protected boolean isValidActivityAmountLevel1(byte[] edt) {
		return edt != null && edt.length <= 128;
	}
	/**
	 ...
	 * <br>
	 * Contents of property :<br>
	 * This property indicates 8 different activity amount levels.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * 0x31.0x38<br>
	 * <br>
	 ...
	 * Get - mandatory<br>
	 */
	protected boolean isValidActivityAmountLevel2(byte[] edt) {
	 ...
	 * <br>
	 * Contents of property :<br>
	 * Array element number information retained by activity amount level 1.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
...
bytes<br>
		 ...
		 * Get - mandatory<br>
		 */
		protected void onGetActivityAmountLevel2(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
		/**
		 * Property name : Human body existence information<br>
		 * <br>
		 * EPC : 0xE3<br>
