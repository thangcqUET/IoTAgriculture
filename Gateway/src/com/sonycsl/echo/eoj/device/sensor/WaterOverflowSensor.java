...
public abstract class WaterOverflowSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x0018;
	...
	/**
	 * Property name : Water overflow detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates water overflow status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Water overflow detection status found<br>
	 * = 0x41<br>
	 * Water overflow detection status not found = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 * Data size : 1 byte<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getWaterOverflowDetectionStatus();
	/**
	 * Property name : Water overflow detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidWaterOverflowDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_WATER_OVERFLOW_DETECTION_STATUS : return getWaterOverflowDetectionStatus();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_WATER_OVERFLOW_DETECTION_STATUS : return isValidWaterOverflowDetectionStatus(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL : 
				...
				return true;
			case EPC_WATER_OVERFLOW_DETECTION_STATUS : 
				onGetWaterOverflowDetectionStatus(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetWaterOverflowDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Getter reqGetWaterOverflowDetectionStatus() {
			reqGetProperty(EPC_WATER_OVERFLOW_DETECTION_STATUS);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Informer reqInformWaterOverflowDetectionStatus() {
			reqInformProperty(EPC_WATER_OVERFLOW_DETECTION_STATUS);
			return this;
		}
	}

	public static class Proxy extends WaterOverflowSensor {
		...
		@Override
		protected byte[] getWaterOverflowDetectionStatus() {return null;}
	}
