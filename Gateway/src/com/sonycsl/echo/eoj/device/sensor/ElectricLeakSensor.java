...
public abstract class ElectricLeakSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x0006;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS = (byte)0xB1;
	public static final byte EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS_RESETTING = (byte)0xBF;
	...
	/**
	 * Property name : Electric leak occurrence status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates leak occurrence status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Electric leak occurrence status found = 0x41<br>
	 * Electric leak occurrence status not found = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 * Data size : 1 byte<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getElectricLeakOccurrenceStatus();
	/**
	 * Property name : Electric leak occurrence status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidElectricLeakOccurrenceStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	/**
	 * Property name : Electric leak occurrence status resetting<br>
	 * <br>
	 * EPC : 0xBF<br>
	 * <br>
	 * Contents of property :<br>
	 * Resets electric leak occurrence status by setting 0x00.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Reset = 0x00<br>
	 * <br>
	 ...
	 * Get - undefined<br>
	 */
	protected boolean setElectricLeakOccurrenceStatusResetting(byte[] edt) {return false;}
	/**
	 * Property name : Electric leak occurrence status resetting<br>
	 * <br>
	 * EPC : 0xBF<br>
	 ...
	 * Get - undefined<br>
	 */
	protected boolean isValidElectricLeakOccurrenceStatusResetting(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	...
	protected synchronized boolean setProperty(EchoProperty property) {
		...
		case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS_RESETTING : return setElectricLeakOccurrenceStatusResetting(property.edt);
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS : return getElectricLeakOccurrenceStatus();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS : return isValidElectricLeakOccurrenceStatus(property.edt);
		case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS_RESETTING : return isValidElectricLeakOccurrenceStatusResetting(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onSetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS_RESETTING : 
				onSetElectricLeakOccurrenceStatusResetting(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL : 
				...
				return true;
			case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS : 
				onGetElectricLeakOccurrenceStatus(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetElectricLeakOccurrenceStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
		/**
		 * Property name : Electric leak occurrence status resetting<br>
		 * <br>
		 * EPC : 0xBF<br>
		 ...
		 * Get - undefined<br>
		 */
		protected void onSetElectricLeakOccurrenceStatusResetting(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Proxy extends ElectricLeakSensor {
		...
		@Override
		protected byte[] getElectricLeakOccurrenceStatus() {return null;}
	}
