...
public abstract class VOCSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x001D;
	...
	/**
	 * Property name : VOC detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates VOC detection status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * VOC detection status found = 0x41 VOC detection status not found<br>
	 * = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidVocDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	/**
	 * Property name : Measured value of VOC concentration<br>
	 * <br>
	 * EPC : 0xE0<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates measured value of VOC concentration in ppm.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 ...
	 * Get - mandatory<br>
	 */
	protected boolean isValidMeasuredValueOfVocConcentration(byte[] edt) {
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_VOC_DETECTION_STATUS : return getVocDetectionStatus();
		case EPC_MEASURED_VALUE_OF_VOC_CONCENTRATION : return getMeasuredValueOfVocConcentration();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_VOC_DETECTION_STATUS : return isValidVocDetectionStatus(property.edt);
		case EPC_MEASURED_VALUE_OF_VOC_CONCENTRATION : return isValidMeasuredValueOfVocConcentration(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_VOC_DETECTION_STATUS : 
				onGetVocDetectionStatus(eoj, tid, esv, property, success);
				return true;
			case EPC_MEASURED_VALUE_OF_VOC_CONCENTRATION : 
				onGetMeasuredValueOfVocConcentration(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetVocDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
		/**
		 * Property name : Measured value of VOC concentration<br>
		 * <br>
		 * EPC : 0xE0<br>
		 ...
		 * Get - mandatory<br>
		 */
		protected void onGetMeasuredValueOfVocConcentration(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetVocDetectionStatus() {
			reqGetProperty(EPC_VOC_DETECTION_STATUS);
			return this;
		}
		/**
		 * Property name : Measured value of VOC concentration<br>
		...
		public Getter reqGetMeasuredValueOfVocConcentration() {
			reqGetProperty(EPC_MEASURED_VALUE_OF_VOC_CONCENTRATION);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		...
		public Informer reqInformVocDetectionStatus() {
			reqInformProperty(EPC_VOC_DETECTION_STATUS);
			return this;
		}
		/**
		 * Property name : Measured value of VOC concentration<br>
		...
		public Informer reqInformMeasuredValueOfVocConcentration() {
			reqInformProperty(EPC_MEASURED_VALUE_OF_VOC_CONCENTRATION);
			return this;
		}
	}

	public static class Proxy extends VOCSensor {
		...
		@Override
		protected byte[] getMeasuredValueOfVocConcentration() {return null;}
	}
