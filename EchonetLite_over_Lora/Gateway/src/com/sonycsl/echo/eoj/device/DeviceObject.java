...
public abstract class DeviceObject extends EchoObject {
	...
	public void setActuallyAnewDevice(Boolean actuallyAnewDevice) {
		this.actuallyAnewDevice = actuallyAnewDevice;
	}

	public Boolean getActuallyAnewDevice(){
		return  actuallyAnewDevice;
	}
	...
	protected boolean isValidOperationStatus(byte[] edt) {
        ...
        return edt[0] == EDT_OPERATION_STATUS_ON[0] || edt[0] == EDT_OPERATION_STATUS_OFF[0];
    }
	/**
	...
	protected boolean isValidIdentificationNumber(byte[] edt) {
        return edt != null && (edt.length == 9 || edt.length == 17);
    }
	...
	protected boolean isValidManufacturersFaultCode(byte[] edt) {
        return edt != null && edt.length <= 255;
    }
	...
	public static class Receiver extends EchoObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			switch(property.epc) {
				...
				case EPC_GET_PROPERTY_MAP :
					...
					return true;
				case EPC_MEDIUM_CAPACITY :
					onGetMediumCapacity(eoj, tid, esv, property, success);
					return true;
				case EPC_MAC_ADDRESS :
					onGetMacAddress(eoj, tid, esv, property, success);
					return true;
				default :
					return false;
			}
		...
		// add manually
		protected void onGetMacAddress(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	...
	public static class Setter extends EchoObject.Setter {
		...
		public Setter reqSetOperationStatusAndPowerLimit(byte[] edt1, byte[] edt2)
		{
			reqSetProperty(EPC_OPERATION_STATUS, edt1);
			reqSetProperty(EPC_POWER_LIMIT_SETTING, edt2);
			return this;
		}
		/**
		 * This property indicates the installation location<br>
	...
	public static class Getter extends EchoObject.Getter {
		...
		public Getter reqGetMediumCapacity()
		{
			reqGetProperty(EPC_MEDIUM_CAPACITY);
			return this;
		}

		public Getter reqGetMacAddress()
		{
			reqGetProperty(EPC_MAC_ADDRESS);
			return this;
		}
	}
