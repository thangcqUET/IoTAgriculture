...
/*
	...
	public static abstract class Task {
		...
		protected static void checkObjectInFrame(EchoFrame frame) {
			...
			//Thang cmt: add nodeProfile into echoNode
			...
			//add device into List Devices if the device is new
			...
			//Thang cmt: this code never run 226:234
			if(seoj == null) {
				if(flagNewNode) {
			...
			//Thang cmt: 2 case: seoj is NodeProfile vs seoj is DeviceObject
