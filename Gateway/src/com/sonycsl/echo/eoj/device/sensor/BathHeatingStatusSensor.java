...
public abstract class BathHeatingStatusSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x0016;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_BATH_HEATING_DETECTION_STATUS = (byte)0xB1;
	...
	/**
	 * Property name : Bath heating detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates bath heating detection status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Bath heating detection status found<br>
	 * = 0x41<br>
	 * Bath heating detection status not found<br>
	 * = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getBathHeatingDetectionStatus();
	/**
	 * Property name : Bath heating detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidBathHeatingDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_BATH_HEATING_DETECTION_STATUS : return getBathHeatingDetectionStatus();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_BATH_HEATING_DETECTION_STATUS : return isValidBathHeatingDetectionStatus(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL : 
				...
				return true;
			case EPC_BATH_HEATING_DETECTION_STATUS : 
				onGetBathHeatingDetectionStatus(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetBathHeatingDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Getter reqGetBathHeatingDetectionStatus() {
			reqGetProperty(EPC_BATH_HEATING_DETECTION_STATUS);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Informer reqInformBathHeatingDetectionStatus() {
			reqInformProperty(EPC_BATH_HEATING_DETECTION_STATUS);
			return this;
		}
	}

	public static class Proxy extends BathHeatingStatusSensor {
