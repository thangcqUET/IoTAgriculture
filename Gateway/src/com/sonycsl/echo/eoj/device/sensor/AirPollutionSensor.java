...
public abstract class AirPollutionSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x000B;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_AIR_POLLUTION_DETECTION_STATUS = (byte)0xB1;
	 ...
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Air pollution detection status found<br>
	 * = 0x41<br>
	 * Air pollution detection status not found = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 * Data size : 1 byte<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getAirPollutionDetectionStatus();
	/**
	 * Property name : Air pollution detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	...
	public static class Proxy extends AirPollutionSensor {
