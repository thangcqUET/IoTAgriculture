...
public abstract class FirstAidSensor extends DeviceObject {
	 ...
	 * = 0x41<br>
	 * First-aid occurrence status not found = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 * Data size : 1 byte<br>
	...
	public static class Setter extends DeviceObject.Setter {
		...
		public Setter reqSetFirstAidOccurrenceStatusResetting(byte[] edt) {
			reqSetProperty(EPC_FIRST_AID_OCCURRENCE_STATUS_RESETTING, edt);
			return this;
		}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetFirstAidOccurrenceStatus() {
			reqGetProperty(EPC_FIRST_AID_OCCURRENCE_STATUS);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		...
		public Informer reqInformFirstAidOccurrenceStatus() {
			reqInformProperty(EPC_FIRST_AID_OCCURRENCE_STATUS);
			return this;
		}
	}
