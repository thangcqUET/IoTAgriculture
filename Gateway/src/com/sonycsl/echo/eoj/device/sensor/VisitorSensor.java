...
public abstract class VisitorSensor extends DeviceObject {
	...
	public static final short ECHO_CLASS_CODE = (short)0x0008;
	...
	/**
	 * Property name : Visitor detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates visitor detection status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Visitor detection status found<br>
	 * = 0x41<br>
	 * Visitor detection status not found<br>
	 * = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidVisitorDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	/**
	 * Property name : Visitor detection holding time<br>
	 * <br>
	 * EPC : 0xBE<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates visitor detection holding time in units of 10 seconds.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * 0x0000.0xFFFD<br>
	 ...
	 * Get - optional<br>
	 */
	protected boolean isValidVisitorDetectionHoldingTime(byte[] edt) {
	...
	protected synchronized boolean setProperty(EchoProperty property) {
		...
		case EPC_VISITOR_DETECTION_HOLDING_TIME : return setVisitorDetectionHoldingTime(property.edt);
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_VISITOR_DETECTION_STATUS : return getVisitorDetectionStatus();
		case EPC_VISITOR_DETECTION_HOLDING_TIME : return getVisitorDetectionHoldingTime();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_VISITOR_DETECTION_STATUS : return isValidVisitorDetectionStatus(property.edt);
		case EPC_VISITOR_DETECTION_HOLDING_TIME : return isValidVisitorDetectionHoldingTime(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onSetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_VISITOR_DETECTION_HOLDING_TIME : 
				onSetVisitorDetectionHoldingTime(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_VISITOR_DETECTION_STATUS : 
				onGetVisitorDetectionStatus(eoj, tid, esv, property, success);
				return true;
			case EPC_VISITOR_DETECTION_HOLDING_TIME : 
				onGetVisitorDetectionHoldingTime(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetVisitorDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
		/**
		 * Property name : Visitor detection holding time<br>
		 * <br>
		 * EPC : 0xBE<br>
		 ...
		 * Get - optional<br>
		 */
		protected void onSetVisitorDetectionHoldingTime(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
		/**
		 * Property name : Visitor detection holding time<br>
		 * <br>
		 * EPC : 0xBE<br>
		 ...
		 * Get - optional<br>
		 */
		protected void onGetVisitorDetectionHoldingTime(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Setter extends DeviceObject.Setter {
		...
		public Setter reqSetVisitorDetectionHoldingTime(byte[] edt) {
			reqSetProperty(EPC_VISITOR_DETECTION_HOLDING_TIME, edt);
			return this;
		}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetVisitorDetectionStatus() {
			reqGetProperty(EPC_VISITOR_DETECTION_STATUS);
			return this;
		}
		/**
		 * Property name : Visitor detection holding time<br>
		...
		public Getter reqGetVisitorDetectionHoldingTime() {
			reqGetProperty(EPC_VISITOR_DETECTION_HOLDING_TIME);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		...
		public Informer reqInformVisitorDetectionStatus() {
			reqInformProperty(EPC_VISITOR_DETECTION_STATUS);
			return this;
		}
		/**
		 * Property name : Visitor detection holding time<br>
		...
		public Informer reqInformVisitorDetectionHoldingTime() {
			reqInformProperty(EPC_VISITOR_DETECTION_HOLDING_TIME);
			return this;
		}
	}

	public static class Proxy extends VisitorSensor {
		...
		@Override
		protected byte[] getVisitorDetectionStatus() {return null;}
	}
