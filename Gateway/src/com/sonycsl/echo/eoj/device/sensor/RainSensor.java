...
public abstract class RainSensor extends DeviceObject {
	
	public static final short ECHO_CLASS_CODE = (short)0x0013;

	public static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	public static final byte EPC_RAIN_DETECTION_STATUS = (byte)0xB1;
	...
	/**
	 * Property name : Rain detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 * <br>
	 * Contents of property :<br>
	 * This property indicates rain detection status.<br>
	 * <br>
	 * Value range (decimal notation) :<br>
	 * Rain detection status found = 0x41 Rain detection status not found<br>
	 * = 0x42<br>
	 * <br>
	 * Data type : unsigned char<br>
	 * <br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected abstract byte[] getRainDetectionStatus();
	/**
	 * Property name : Rain detection status<br>
	 * <br>
	 * EPC : 0xB1<br>
	 ...
	 * <b>Announcement at status change</b><br>
	 */
	protected boolean isValidRainDetectionStatus(byte[] edt) {
		return edt != null && edt.length == 1;
	}
	...
	protected synchronized byte[] getProperty(byte epc) {
		...
		case EPC_RAIN_DETECTION_STATUS : return getRainDetectionStatus();
		default : return null;
		}
	}
	...
	protected synchronized boolean isValidProperty(EchoProperty property) {
		...
		case EPC_RAIN_DETECTION_STATUS : return isValidRainDetectionStatus(property.edt);
		default : return false;
		}
	}
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected boolean onGetProperty(EchoObject eoj, short tid, byte esv,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL : 
				...
				return true;
			case EPC_RAIN_DETECTION_STATUS : 
				onGetRainDetectionStatus(eoj, tid, esv, property, success);
				return true;
			default :
				return false;
			}
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		protected void onGetRainDetectionStatus(EchoObject eoj, short tid, byte esv, EchoProperty property, boolean success) {}
	}
	...
	public static class Getter extends DeviceObject.Getter {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Getter reqGetRainDetectionStatus() {
			reqGetProperty(EPC_RAIN_DETECTION_STATUS);
			return this;
		}
	}
	...
	public static class Informer extends DeviceObject.Informer {
		 ...
		 * <b>Announcement at status change</b><br>
		 */
		public Informer reqInformRainDetectionStatus() {
			reqInformProperty(EPC_RAIN_DETECTION_STATUS);
			return this;
		}
	}

	public static class Proxy extends RainSensor {
		...
		@Override
		protected byte[] getRainDetectionStatus() {return null;}
	}
